# Ingest queue — 449 sources, wave-ordered
...
- [ ] `lavenex-2000-hippocampal-neocortical-hierarchy-of-associativity.md` — hippocampal-entorhinal · S · 2000 — `LOSSY` (pdf2md, pymupdf4llm — Wiley serves no HTML; check the connectivity figures by hand); Hippocampus 10(4):420–430 (Lavenex & Amaral); perirhinal → parahippocampal → entorhinal associational networks integrate unimodal and polymodal cortical input *before* anything reaches the hippocampal formation — the medial-temporal interface is a processing hierarchy of associativity, not a cable, which constrains how much has already been mixed upstream of any hippocampal code · `T347`, `T28`
- [ ] `frankland-2005-organization-of-recent-and-remote-memories.md` — memory-consolidation · S · 2005 — user-clipped; Nat. Rev. Neurosci. 6(2):119–130 (Frankland & Bontempi); lesion, imaging and immediate-early-gene results ordered by memory age across hippocampus and prefrontal cortex — the evidence base `T97` was opened against and never read, so the row's `Closes when` ("re-examine the selective-remote-role experiments for a weak recent one") is answerable from this one source · `T97`, `T82`
- [ ] `harris-2015-neocortical-circuit-themes-and-variations.md` — cortical-columns · S · 2015 — user-clipped, Tables 1–2 clipped separately and merged into the body; Nat. Neurosci. 18(2):170–181 (Harris & Shepherd); cell-class-by-cell-class input/output tables for excitatory (IT/PT/CT) and inhibitory (Pvalb/Sst/Htr3a) classes, with cortex as *serially homologous* — hodology rather than lamination as the organizing principle, which is the **variations** half [[wiki/concepts/canonical-cortical-microcircuit.md]] lacks · `T244`, `T252`
- [ ] `gilboa-2017-neurobiology-of-schemas.md` — memory-consolidation · S · 2017 — user-clipped; Trends Cogn. Sci. 21(8):618–631 (Gilboa & Marlatte); schema instantiation modulates perception and encoding, ventromedial prefrontal cortex as locus, and schema-consistent material integrates into neocortex *faster* — the primary source [[wiki/concepts/schema-assimilation.md]] has never had, Tse 2007 being an excluded venue · `T82`, `G14`
- [ ] `klinzing-2019-mechanisms-of-systems-consolidation-during-sleep.md` — memory-consolidation · S · 2019 — user-clipped; Nat. Neurosci. 22(10):1598–1610 (Klinzing, Niethard & Born); slow-oscillation / spindle / ripple nesting as the **timing protocol** that says when the hippocampo-cortical channel is open, embedded in global synaptic downscaling, plus the qualitative gist-like transformation claim; defines the stimulation target `T82`'s `Closes when` calls for · `T34`, `T81`, `G14`
- [ ] `teyler-2007-hippocampal-indexing-theory-updated.md` — hippocampal-entorhinal · F · 2007 — `LOSSY` (pdf2md, pymupdf4llm — Wiley serves no HTML); Hippocampus 17(12):1158–1169 (Teyler & Rudy); the indexing theory's own 20-year update — the hippocampus stores an index *to* the neocortical pattern an episode produced, so a partial cue reinstates the whole; gives `T28` position B a primary source instead of [[wiki/entities/tolman-eichenbaum-machine.md]], which presupposes it · `T28`
- [ ] `larkum-2013-cellular-mechanism-for-cortical-associations.md` — cortical-columns · F · 2013 — user-clipped; Trends Neurosci. 36(3):141–151 (Larkum); coincident basal (bottom-up) and apical-tuft (top-down) input triggers a dendritic calcium spike and a burst — association stated as a *site* inside one pyramidal cell, gated by compartment-targeting inhibition, which is the mechanism that would make a level broadcast rather than relay · `T259`, `T302`
