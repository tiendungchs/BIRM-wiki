...
- [x] `barbu-2019-objectnet.md` — reasoning-eval · B · 2019 · **LOSSY** (pdf2md)
...
- [x] `ha-2018-world-models.md` — world-models · M · 2018
- [x] `chandra-2025-episodic-associative-memory-spatial-scaffolds.md` — hippocampal-entorhinal · M · 2025
...
- [x] `parsons-2022-analogy-component-processes.md` — analogy-abstraction · S · 2022
- [x] `lambonralph-2017-neural-computational-bases-semantic-cognition.md` — semantic-cognition · S · 2017
- [x] `chau-2025-lateral-frontopolar-functions.md` — prefrontal-control · S · 2025
- [x] `knowlton-2012-neurocomputational-relational-reasoning.md` — analogy-abstraction · F · 2012
- [x] `roux-2014-wm-oscillations-alpha-gamma-theta-gamma.md` — working-memory · F · 2014
- [x] `zeithamova-2012-retrieval-mediated-learning-inference.md` — hippocampal-entorhinal · R · 2012
- [x] `hobeika-2016-analogical-reasoning-metaanalysis.md` — analogy-abstraction · R · 2016
- [x] `urbanski-2016-left-frontal-pole-analogy.md` — analogy-abstraction · R · 2016 · **LOSSY** (pdf2md)
- [x] `mole-2025-right-frontal-network-reasoning.md` — analogy-abstraction · R · 2025

Not acquired: Waltz et al. 1999, *A system for relational reasoning in human prefrontal cortex* (`G104`, `T293`) — pre-2000 scan with no text layer; still cited second-hand, so a later wave should find a first-hand restatement.
...
- [x] `kirsanov-2026-vectorized-dendritic-gradients.md` — plasticity · S · 2026
- [x] `kirsanov-2026-plasticity-beyond-textbook-rules.md` — plasticity · S · 2026
- [x] `talk-nd-motor-cortex-dynamics.txt` — attractor-dynamics · X · nd
- [x] `webb-2024-relational-bottleneck-inductive-bias.md` — analogy-abstraction · F · 2024
- [x] `lundqvist-2016-gamma-beta-bursts-underlie-working-memory.md` — working-memory · R · 2016
- [x] `wendelken-2012-rlpfc-domain-general-or-domain-sensitive.md` — analogy-abstraction · R · 2012
...
- [x] `witter-2017-entorhinal-cortex-architecture.md` — hippocampal-entorhinal · S · 2017
...
- [x] `keller-2018-predictive-processing-canonical-cortical-computation.md` — predictive-coding · S · 2018
- [x] `wolpert-1998-internal-models-cerebellum.md` — world-models · F · 1998
- [x] `rao-1999-predictive-coding-visual-cortex.md` — predictive-coding · F · 1999
- [x] `hawkins-2019-framework-intelligence-cortical-grid-cells.md` — cortical-columns · F · 2019
- [x] `leinweber-2017-sensorimotor-circuit-visual-flow-predictions.md` — predictive-coding · R · 2017
- [x] `schneider-2018-cortical-filter-acoustic-consequences-movement.md` — predictive-coding · R · 2018
...
- [x] `hoydal-2019-object-vector-coding-mec.md` — hippocampal-entorhinal · R · 2019
- [x] `gornet-2024-cognitive-maps-visual-predictive-coding.md` — hippocampal-entorhinal · R · 2024
...
- [x] `baxter-2000-model-of-inductive-bias-learning.md` — foundations · F · 2000 · **LOSSY** (pdf2md)
- [x] `bengio-2009-curriculum-learning.md` — foundations · F · 2009 · **LOSSY** (pdf2md)
- [x] `blundell-2016-model-free-episodic-control.md` — rl-planning · M · 2016
- [x] `cai-2017-neural-programming-generalize-via-recursion.md` — neurosymbolic · M · 2017 · **LOSSY** (pdf2md)
- [x] `rosas-2019-high-order-interdependencies-o-information.md` — latent-graph · M · 2019
- [x] `sagawa-2020-group-dro-worst-case-generalization.md` — foundations · B · 2020
- [x] `wolff-2017-dynamic-hidden-states-working-memory.md` — working-memory · R · 2017
- [x] `laumann-2017-stability-bold-fmri-correlations.md` — brain-networks · R · 2017
- [x] `orhan-2020-self-supervised-eyes-of-a-child.md` — ssl-representation · R · 2020
- [x] `ericsson-2021-how-well-self-supervised-models-transfer.md` — ssl-representation · R · 2021
- [x] `golubeva-2021-wider-nets-same-parameter-count.md` — foundations · R · 2021
- [x] `zeraati-2022-bayesian-unbiased-timescale-estimation.md` — brain-networks · R · 2022
- [x] `chari-2023-specious-art-single-cell-genomics.md` — mech-interp · R · 2023
- [x] `wang-2023-ligo-learning-to-grow-pretrained-models.md` — attention-transformers · R · 2023
- [x] `garrido-2023-rankme-representation-rank-downstream.md` — ssl-representation · R · 2023
...
- [x] `lammel-2012-input-specific-reward-aversion-vta.md` — rl-planning · R · 2012
- [x] `betley-2015-hunger-thirst-negative-valence-teaching-signal.md` — rl-planning · R · 2015
...
- [x] `cardinal-2002-emotion-motivation-amygdala-ventral-striatum-pfc.md` — rl-planning · S · 2002
- [x] `oudeyer-2007-what-is-intrinsic-motivation-typology.md` — rl-planning · S · 2007
- [x] `gottlieb-2018-active-sampling-and-curiosity.md` — rl-planning · S · 2018
- [x] `hu-2020-lateral-habenula-circuits-and-functions.md` — rl-planning · S · 2020
- [x] `robinson-2025-incentive-sensitization-30-years-on.md` — rl-planning · S · 2025
- [x] `zhang-2009-neural-computational-model-incentive-salience.md` — rl-planning · F · 2009
- [x] `salge-2013-empowerment-an-introduction.md` — rl-planning · F · 2013
- [x] `shenhav-2013-expected-value-of-control.md` — rl-planning · F · 2013
- [x] `solway-2014-optimal-behavioral-hierarchy.md` — rl-planning · F · 2014
- [x] `machado-2017-laplacian-framework-option-discovery.md` — rl-planning · M · 2017
- [x] `andrychowicz-2017-hindsight-experience-replay.md` — rl-planning · M · 2017 · **LOSSY** (pdf2md)
- [x] `matsumoto-2007-lateral-habenula-negative-reward-signals.md` — rl-planning · R · 2007
- [x] `ribasfernandes-2011-neural-signature-hierarchical-rl.md` — rl-planning · R · 2011
- [x] `namburi-2015-amygdala-projection-specific-valence-plasticity.md` — rl-planning · R · 2015
- [x] `shabel-2019-stress-transforms-habenula-reward-to-punishment.md` — rl-planning · R · 2019
- [x] `ten-2021-humans-monitor-learning-progress.md` — rl-planning · R · 2021
...
- [x] `frankland-2005-organization-of-recent-and-remote-memories.md` — memory-consolidation · S · 2005
- [x] `harris-2015-neocortical-circuit-themes-and-variations.md` — cortical-columns · S · 2015
- [x] `gilboa-2017-neurobiology-of-schemas.md` — memory-consolidation · S · 2017
- [x] `klinzing-2019-mechanisms-of-systems-consolidation-during-sleep.md` — memory-consolidation · S · 2019
- [x] `teyler-2007-hippocampal-indexing-theory-updated.md` — hippocampal-entorhinal · F · 2007 · **LOSSY** (pdf2md)
- [x] `larkum-2013-cellular-mechanism-for-cortical-associations.md` — cortical-columns · F · 2013
- [x] `kumaran-2016-complementary-learning-systems-updated.md` — memory-consolidation · F · 2016
- [x] `aru-2020-cellular-mechanisms-of-conscious-processing.md` — consciousness-global-workspace · F · 2020
- [x] `ji-2007-coordinated-replay-visual-cortex-hippocampus.md` — memory-consolidation · R · 2007
- [x] `markov-2014-anatomy-of-cortical-hierarchy.md` — visual-cortex · R · 2014
- [x] `bastos-2015-feedforward-feedback-frequency-channels.md` — visual-cortex · R · 2015
- [x] `rothschild-2017-cortical-hippocampal-cortical-loop.md` — memory-consolidation · R · 2017
- [x] `jordan-2020-opposing-topdown-bottomup-layer23-v1.md` — predictive-coding · R · 2020
...
- [x] `aggleton-2022-anterior-thalamic-nuclei-tripartite-memory-system.md` — thalamocortical · S · 2022
- [x] `foster-2023-tripartite-view-of-posterior-cingulate-cortex.md` — default-mode · S · 2023
- [x] `alexander-2023-rethinking-retrosplenial-cortex.md` — hippocampal-entorhinal · S · 2023
- [x] `kinman-2026-subiculum-cell-type-specific-composition.md` — hippocampal-entorhinal · S · 2026
- [x] `bicanski-2018-neural-level-model-of-spatial-memory-and-imagery.md` — hippocampal-entorhinal · F · 2018
- [x] `alexander-2015-retrosplenial-conjunction-of-internal-and-external-spaces.md` — hippocampal-entorhinal · R · 2015
...
- [x] `kravitz-2011-new-neural-framework-for-visuospatial-processing.md` — visual-cortex · S · 2011
- [x] `nieder-2016-neuronal-code-for-number.md` — prefrontal-control · S · 2016
- [x] `pearson-2019-human-imagination-visual-mental-imagery.md` — visual-cortex · S · 2019
- [x] `ullman-1984-visual-routines.md` — visual-cortex · F · 1984 · **LOSSY** (pdf2md)
- [x] `ballard-1997-deictic-codes-for-embodiment-of-cognition.md` — embodied-robotics · F · 1997 · **LOSSY** (pdf2md)
- [x] `pylyshyn-2001-visual-indexes-preconceptual-objects.md` — visual-cortex · F · 2001 · **LOSSY** (pdf2md)
- [x] `mollard-2026-multiscale-incremental-grouping.md` — visual-cortex · F · 2026
- [x] `rahmanzadehgervi-2024-vision-language-models-are-blind.md` — reasoning-eval · M · 2024
- [x] `hu-2025-arc-is-a-vision-problem.md` — arc-benchmarks · R · 2025
- [x] `acuaviva-2025-rethinking-visual-intelligence-video-pretraining.md` — world-models · R · 2025
...
- [x] `ecoffet-2021-first-return-then-explore.md` — rl-planning · M · 2021
