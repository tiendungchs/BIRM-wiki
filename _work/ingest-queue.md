...
- [ ] `bengio-2009-curriculum-learning.md` — foundations · F · 2009 — `LOSSY` (pdf2md from the ACM PDF); ICML 2009:41–48; easy-to-hard ordering as a continuation method on a non-convex objective — the artefact the wiki's 39 `curricul*` pages all borrow from without an owner · `L20`, `P26`, `G100`
