...
_Empty._ Wave 26's sixteen rows were filed on 2026-09-20 (`_work/manifest.tsv` rows 477–492,
`_work/ingest-queue.md` wave 26). The next ACQUIRE pass writes the wave-27 rows here.
