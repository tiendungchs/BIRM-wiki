...
- **[[wiki/concepts/schema-assimilation.md]]** — the rival, structure-based route to the same behaviour: that page passes its property (iii) by having an organized schema to assimilate into, while this model passes it with no schema at all, by recirculating retrievals until they settle.
