...
- **No contamination audit.** The problems are drawn from decades of public competitions and are extensively discussed on the open web, including on AoPS itself. The paper does not measure train/pretrain overlap; every later score on MATH inherits that.
