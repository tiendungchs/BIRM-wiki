...
- **[[wiki/concepts/representational-collapse.md]]** — the demonstration that a stack can be held up at every level by the same three-term provision, retiring the objection that no JEPA stack had been trained at all.
