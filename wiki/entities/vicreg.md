...
- **[[wiki/entities/lejepa.md]]** — the generalisation this page is a special case of: SIGReg with a two-moment test *is* this objective, so the difference is not a rival family but how many moments of `N(0, I)` are pinned, and the extra moments buy identifiability (no non-Gaussian solution satisfies the characteristic-function test) at no extra coefficient.
