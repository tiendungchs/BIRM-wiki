...
| **DreamCoder on ARC** (Banburski et al. 2020; Alford et al. 2022) | Library learning over hand-defined grid primitives, demonstrated on a small symmetry-focused task set | The only ARC-side instance of the learned-prior proposal disputed at [[wiki/empirical-tensions.md]] T182; scale reported as small |
...
| **Human ARC study** (Johnson et al. 2021) | 95 participants × 10 of 40 public ARC tasks; ~84% mean per-task accuracy, high variance; human errors are near-misses, K1's errors are not | The near-miss finding replicated on the *original* tasks, independently of ConceptARC's authoring |
