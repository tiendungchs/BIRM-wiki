...
- **[[wiki/entities/dqn.md]]** — the control this paper's ablation ladder is scored against, given its own page: the standard an expected-free-energy objective has to beat is a model-free value learner whose only structural commitment is a stack of recent frames.
