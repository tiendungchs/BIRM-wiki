...
- **[[wiki/concepts/external-verification.md]]** — AIXItl's proof-carrying enumeration is the kernel rung applied to *policies* rather than to derivations, and the only mechanism in the wiki whose acceptance test is independent of the thing it admits.
