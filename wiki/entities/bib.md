...
- **[[wiki/concepts/environment-invariance.md]]** — supplies the reading of Colored MNIST's 17.1% ERM test accuracy, this page's below-chance signature reproduced in a fully controlled setting where the anti-correlated feature (colour) is known by construction.
