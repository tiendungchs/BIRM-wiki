...
| Limit | Consequence |
|---|---|
| **A degree-`n` energy is an `n`-body synapse** | Biologically inadmissible as written, and the paper does not address it. The fix — hidden neurons and two-body interactions only — is Krotov & Hopfield 2021, not this paper |
