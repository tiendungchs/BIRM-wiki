...
| G39 | Nothing anchors a retrieved structure to the present situation | part | `L2` | `OPEN` | 19 | [[wiki/gaps/g039.md]] |
...
| G110 | Top-down control is always applied to a module or its output; nothing applies it to the interface that feeds the module | arrangement | `L2` | `OPEN` | 5 | [[wiki/gaps/g110.md]] |
