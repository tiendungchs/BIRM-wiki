...
- **[[wiki/entities/retrosplenial-cortex.md]]** — a second cortical theta generator in the memory system rather than a follower: retrosplenial theta is locally generated, only partially septal-dependent and independent of hippocampal theta, while hippocampal 8–12 Hz rhythmical slow activity is itself partly mediated by this region and/or the cingulum (Vann et al. 2009).
- **[[wiki/entities/anterior-thalamic-nuclei.md]]** — the human measurement on the diencephalic memory stream: anterior-thalamic–neocortical theta synchrony with theta–gamma cross-coupling predicts subsequent memory for complex scenes, and the anteroventral nucleus holds most of the region's theta-modulated cells, jointly driven by fornix and mammillothalamic fibres.
