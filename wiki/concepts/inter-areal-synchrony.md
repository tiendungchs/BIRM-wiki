...
- **[[wiki/concepts/counterstream-organization.md]]** — the anatomy that says what a frequency-tagged direction estimate is actually measuring: supragranular gamma and infragranular beta map onto the two laminar compartments rather than onto feedforward and feedback, and since every short-range pathway mixes both compartments, a band-resolved direction estimate and an SLN-derived one need not agree.
