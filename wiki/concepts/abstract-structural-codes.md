...
- **[[wiki/entities/tolman-eichenbaum-machine.md]]** — the demonstration that `g` can be *learned* from next-observation prediction across an environment family, and reused across worlds by rebinding rather than retraining (Whittington et al. 2022).
