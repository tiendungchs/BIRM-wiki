...
- **[[wiki/concepts/abstraction.md]]** — the geometry that makes the "quarantine" disjunct precise: representing a detail *so that it does not interfere* means confining it to the read-out's null space, which turns a verbal hedge into a statable loss and a measurable quantity.
