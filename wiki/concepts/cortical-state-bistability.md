...
- **[[wiki/concepts/mental-imagery.md]]** — the same paradigm turned into a measuring instrument: binocular rivalry is this page's model of internally driven content switching, and there it is used to score an *imagined* signal's sensory energy by how strongly it biases the next dominance — with the sign of the bias (priming vs adaptation) set by the prior signal's strength × duration.
