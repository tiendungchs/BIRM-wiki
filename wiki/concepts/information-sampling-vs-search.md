...
- **Effort is named as the missing half of every sampling policy.** Changing the attentional set costs something, sampling policies are top-down and memory-dependent, and the review defers to the cognitive-effort literature rather than pricing a query in the same units as its expected gain.
