...
- **[[wiki/concepts/inter-areal-synchrony.md]]** — makes "top-down bias" two testably different operations: a control signal that is *delivered* shows up as gamma coupling that dies when the projection is cut, while one that merely *times* the target shows up as theta coupling that survives it.
