...
| Degree / strength distribution | **Exponential, not scale-free**; ~10-fold range across ROIs | There is no arbitrarily-large hub. Heterogeneity is real but bounded — a design constraint on any "one big router" module |
| Assortativity | Positive | Hubs preferentially wire to hubs; the core is a *club*, not a star |
| Small-worldness | Present | Short paths at low wiring cost |
