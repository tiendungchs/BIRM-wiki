...
- **[[wiki/entities/retrosplenial-cortex.md]]** — the localised rival to this page's Prediction 4: the egocentric↔allocentric conversion is assigned to *one* region applying a rotation parameter delivered by an external head-direction population, rather than replicated inside every sensory cortex — and its lesion profile (near-normal until cues conflict) is the arbitration signature `G43` had no positive case for.
