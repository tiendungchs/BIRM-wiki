...
- **[[wiki/concepts/topological-latent-decoding.md]]** — the same discipline for manifold claims, with two nulls of this page's kind: velocity vectors shuffled across state-space bins (for "is the manifold attractive") and tuning-curve-driven independent spiking at matched Fano factor (for "is anything coded besides the recovered latent").
