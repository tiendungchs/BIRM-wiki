...
- **[[wiki/concepts/canonical-cortical-microcircuit.md]]** — the wiring that makes the apical/basal split anatomical rather than theoretical: inter-areal feedback and subcortical input terminate in layer 1 on distal apical tufts while driving input arrives on layer-4 and basal compartments, so the prediction channel and the evidence channel are separated by cortical geography (Douglas & Martin 2004).
