...
| **Modules mirroring world modularity should be re-usable across tasks** | If mechanisms recur across environments, an agent meeting a new environment need adapt only a few modules | Motivates competitive module training; no measurement of "how many modules had to change" exists |
