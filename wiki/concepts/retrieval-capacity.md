...
- **[[wiki/concepts/vector-symbolic-binding.md]]** — the escape route absent from this page's table: leave the score bilinear and re-encode the *items* until the structural property is a surface feature, which raises what a fixed-`d` dot product can express and pays in dot-product variance rather than in dimension (99/100 correct orderings at `n`=4096 against 94/100 at 2048); the probe-side re-weighting also changes what similarity means without touching the index (T184).
