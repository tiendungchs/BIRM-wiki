...
- **[[wiki/concepts/encoding-retrieval-alternation.md]]** — a biological clock for the free/clamped alternation this page treats as an external schedule: theta phase runs the two equilibria at 4–8 Hz in the hippocampus, with the free phase driven by recurrent completion and the clamped phase by entorhinal input.
