...
- **[[wiki/entities/lateral-frontal-pole.md]]** *(Chau et al. 2025)* — the causal-lesion status of this page's frontopolar integrator, and the challenge to it: 27 focal frontal patients put abstract-feature matching in the left frontal pole (Urbanski et al. 2016), 247 patients put analogy impairment in a frontal network *posterior* to it (Mole et al. 2025), with *identifying* an analogy versus *applying* one the proposed and untested reconciliation. It also offers a non-relational reading of the same region's job — decompose high-dimensional input into several low-dimensional features — which would make relational integration a special case of projection onto a learned basis rather than a primitive.
