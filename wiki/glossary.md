...
| CfC | Closed-form Continuous-time network | An analytical approximation of the LTC solution that removes the internal ODE solver, making the layer feed-forward ([[wiki/entities/ltc.md]]) |
