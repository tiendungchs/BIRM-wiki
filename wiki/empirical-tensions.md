...
| T367 | Is the subgoal-level prediction error carried on its own channel, or on the reward channel with the running option as a mask? | `L2` | `LIVE` | 10 | [[wiki/tensions/t367.md]] |
