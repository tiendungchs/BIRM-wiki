...
**Maintenance.** `Status` and `Level` are **token fields** — one of the tokens in the key above and nothing else; all reasoning belongs in the detail file's `Status` section. `Cited by` counts the concept and entity pages naming the row and is regenerated by `tools/registry-index.py`, which also rebuilds this table from the detail files. A retired row moves to `wiki/tensions/closed/` and leaves the table.

| # | Tension | Level | Status | Cited by | Detail |
|---|---|---|---|---|---|
...
| T8 | Is compositional machinery innate, or acquired from an external symbolic system? | `L0` | `LIVE` | 7 | [[wiki/tensions/t008.md]] |
...
| T16 | Does the shortest program consistent with the data generalize? | `L0` | `LIVE` | 3 | [[wiki/tensions/t016.md]] |
| T17 | Is intelligence universal, or scoped? | `L0` | `LIVE` | 2 | [[wiki/tensions/t017.md]] |
...
| T47 | Are concurrent structural codes independent frames or one code read out in many places? | `L1` | `LIVE` | 5 | [[wiki/tensions/t047.md]] |
...
| T49 | How densely is CA3 recurrently connected — and does pattern completion need *structured* wiring or just enough of it? | `L3` | `LIVE` | 4 | [[wiki/tensions/t049.md]] |
...
| T62 | Should a fast associative store hold instances, or model a distribution? | `L1` | `LIVE` | 6 | [[wiki/tensions/t062.md]] |
...
| T66 | Does layer 6 supply a modulator signal, or the location code that decides what a column represents? | `L2` | `LIVE` | 2 | [[wiki/tensions/t066.md]] |
...
| T78 | Is failure to scale evidence against a learning rule's biological plausibility? | `META` | `LIVE` | 2 | [[wiki/tensions/t078.md]] |
...
| T87 | Is a working memory held at a fixed point, or in a moving trajectory? | `L3` | `LEANING` | 3 | [[wiki/tensions/t087.md]] |
...
| T106 | Do task-trained prefrontal-like recurrent networks settle into attractors, or avoid them? | `L3` | `LIVE` | 4 | [[wiki/tensions/t106.md]] |
| T107 | Which structure holds the graph that a plan runs on — the hippocampal formation, or the cortical controller? | `L1` | `LIVE` | 5 | [[wiki/tensions/t107.md]] |
...
| T140 | Is delay discounting one non-exponential valuation or two competing exponential systems? | `L3` | `LEANING` | 3 | [[wiki/tensions/t140.md]] |
...
| T171 | Does climbing the moment ladder pay? | `L3` | `LIVE` | 3 | [[wiki/tensions/t171.md]] |
| T172 | Is an action-grounded vocabulary necessarily agent-relative? | `L0` | `LIVE` | 2 | [[wiki/tensions/t172.md]] |
...
| T180 | Does verifier-driven test-time search buy reasoning, or only selection? | `L1` | `LIVE` | 3 | [[wiki/tensions/t180.md]] |
| T181 | Is a more accurate verifier always a better verifier? | `L3` | `LEANING` | 2 | [[wiki/tensions/t181.md]] |
| T183 | Is theory of mind recursive inference, or a fixed point? | `L1` | `LIVE` | 4 | [[wiki/tensions/t183.md]] |
| T185 | Does structural similarity influence memory *access*, or only evaluation after access? | `L2` | `LIVE` | 2 | [[wiki/tensions/t185.md]] |
...
| T310 | Does a frozen linear probe rank self-supervised representations? | `L0-INSTR` | `LEANING` | 12 | [[wiki/tensions/t310.md]] |
...
| T314 | Should an anti-collapse provision protect the space the loss sees, or the space the read-out sees? | `L2` | `LIVE` | 7 | [[wiki/tensions/t314.md]] |
...
| T367 | Is the subgoal-level prediction error carried on its own channel, or on the reward channel with the running option as a mask? | `L2` | `LIVE` | 9 | [[wiki/tensions/t367.md]] |
...
| T389 | Is the place-cell code generated by recurrent attractor dynamics, or is it a feedforward conjunction that only looks like one? | `L2` | `LIVE` | 5 | [[wiki/tensions/t389.md]] |
| T390 | Is a trained attention head performing associative retrieval, or pooling? | `L2` | `LIVE` | 4 | [[wiki/tensions/t390.md]] |
| T391 | Should a fast store's write gate be uncoordinated across units, sequenced, or rate-regulated? | `L2` | `LIVE` | 5 | [[wiki/tensions/t391.md]] |
| T392 | Is forgetting the loss of a trace, or the loss of its address? | `L1` | `LIVE` | 4 | [[wiki/tensions/t392.md]] |
...
| T395 | Does a second-order cue retrieve the specific outcome's value, or only a US-general affective state? | `L1` | `LIVE` | 9 | [[wiki/tensions/t395.md]] |
